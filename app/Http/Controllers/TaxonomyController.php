            ...
            return Datatables::of($category)
                ->addColumn(
                    ...
                    <button data-href="{{action(\'TaxonomyController@edit\', [$id])}}?type=' . $category_type . '" class="btn btn-xs btn-primary edit_category_button"><i class="glyphicon glyphicon-edit"></i>  @lang("messages.edit")</button>
                        ...
                        <button data-href="{{action(\'TaxonomyController@destroy\', [$id])}}" class="btn btn-xs btn-danger delete_category_button tuyd><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>
                    '
                )
