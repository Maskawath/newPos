	...
	<section class="content">
		...
		<div class="row">
			...
			<div class="btn-group pull-right" data-toggle="buttons">
				<label class="btn btn-info top-btn-chg active">
    				<input type="radio" name="date-filter"
    				data-start="{{ date('Y-m-d') }}" 
    				data-end="{{ date('Y-m-d') }}"
    				checked> {{ __('home.today') }}
  				</label>
  				<label class="btn btn-info top-btn-chg">
    				<input type="radio" name="date-filter"
  				...
  				<label class="btn btn-info top-btn-chg chg-last">
    				<input type="radio" name="date-filter" 
	...
	<br/>
		<div class="row">
	        <div class="col-lg-4 col-xs-6">
	          <!-- small box -->
	          <div class="small-box bg-custom-bro">
	            <div class="inner">
	              <h3><span class="new_subscriptions">&nbsp;</span></h3>

	              <p class="subscription-new">@lang('superadmin::lang.new_subscriptions')</p>
	            </div>
	            <div class="icon">
	              <i class="fa fa-refresh new-color-icon"></i>
	            </div>
	            <a href="{{action('\Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController@index')}}" class="small-box-footer">@lang('superadmin::lang.more_info') 
					<i class="fa fa-arrow-circle-right fa-rgt-arrow"></i></a>
	          </div>
	        </div>
	        <!-- ./col -->
	        ...
	        <div class="col-lg-4 col-xs-6">
	          ...
	          <div class="small-box bg-custom-bro">
	            <div class="inner">
	              ...
	              <p class="subscription-new">@lang('superadmin::lang.new_registrations')</p>
	            </div>
	            <div class="icon">
	              <i class="ion ion-person-add new-color-icon"></i>
	            </div>
	            <a href="{{action('\Modules\Superadmin\Http\Controllers\BusinessController@index')}}" class="small-box-footer">@lang('superadmin::lang.more_info') <i class="fa fa-arrow-circle-right fa-rgt-arrow"></i></a>
	          </div>
	        </div>
	        <!-- ./col -->
	        ...
	        <div class="col-lg-4 col-xs-6">
	          ...
	          <div class="small-box bg-custom-bro">
	            <div class="inner">
	              ...
	              <p class="subscription-new">@lang('superadmin::lang.not_subscribed')</p>
	            </div>
	            <div class="icon">
	              <i class="ion ion-pie-graph new-color-icon"></i>
	            </div>
	            <a href="{{action('\Modules\Superadmin\Http\Controllers\BusinessController@index')}}" class="small-box-footer">@lang('superadmin::lang.more_info') <i class="fa fa-arrow-circle-right fa-rgt-arrow"></i></a>
	          </div>
	        </div>
