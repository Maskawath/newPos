  ...
  <header class="main-header no-print">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        ...
        <div class="btn-group">
          <button id="header_shortcut_dropdown" type="button" class="btn btn-success dropdown-toggle btn-flat pull-left m-8 btn-sm mt-10 btn-gt-top" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="m-8 pull-left mt-15 hidden-xs" ><strong>{{ @format_date('now') }}</strong></div>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="user-header-p">{{ Auth::User()->first_name }} {{ Auth::User()->last_name }}</span>
            </a>
            <ul class="dropdown-menu">
